                  ...
                  <table id="example1" class="table table-striped">
                    ...
                    <tbody align="center">
                      ...
                      <tr>
                        ...
                        <td>{{ $service->name }}</td>
                        <td>
                          <a href="{{asset($service->wallpaper)}}" target="_blank"><img src="{{asset($service->wallpaper)}}" alt="{{asset($service->name)}}" height="70" width="70"></a>
                        </td>
                        <td>
                          <a href="{{asset($service->banner)}}" target="_blank"><img src="{{asset($service->banner)}}" alt="{{asset($service->name)}}" height="70" width="70"></a>
                        </td>
                        <td>
                      ...
                      <td>
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item bg" href="{{route('services.view', $service->id)}}">View</a>
...
<script>
  ...
  jQuery(document).ready(function($){
    ...
    var url = '{{ route("services.delete", ":slug") }}';
