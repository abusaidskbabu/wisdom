                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-sm" name="title" placeholder="Enter Page Title" value="{{ old('title') }}">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="input-group mb-2">
                            <div class="input-group-prepend">
                              <div class="input-group-text form-control-sm">www.wisdomvalley.net/</div>
                            </div>
                            <input type="text" class="form-control form-control-sm" name="slug" placeholder="Enter Slug" value="{{ old('slug') }}">
                          </div>
                        </div>
                      </div>
                    </div>
